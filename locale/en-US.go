...
var englishUnitedStates = Formatters{
	...
	-25 * (24 * time.Hour):      func(d time.Duration) string { return fmt.Sprintf("in %.0f days", math.Ceil((-d.Hours()-11.0)/24.0)) },
	...
	25 * (24 * time.Hour):      func(d time.Duration) string { return fmt.Sprintf("%.0f days ago", math.Ceil((d.Hours()-11.0)/24.0)) },
